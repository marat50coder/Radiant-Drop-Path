...
class _NoLinkScreenState extends State<NoLinkScreen> {
  ...
  void initState() {
    ...
    // Allow landscape so the offline artwork rotates (the launch gate locks
  ...
  Widget build(BuildContext context) {
    ...
    // offset that shifts the horizontal centre). Portrait: keep a little
    // bottom room above the home indicator.
      ...
      child: DecoratedBox(
        decoration: BoxDecoration(
          ...
          gradient: const LinearGradient(
            colors: <Color>[Color(0xFF57E6FF), Color(0xFF3A7BFF)],
