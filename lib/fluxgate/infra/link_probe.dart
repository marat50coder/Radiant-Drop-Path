...
/// Connectivity + reachability checks for the flux flow.
class LinkProbe {
  ...
  /// domain) so a VPN or a not-yet-propagated app domain never yields a
  /// false "offline". Each lookup is time-boxed so retry can never hang.
